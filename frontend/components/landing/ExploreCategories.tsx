    ...
    <section className="bg-white py-20">
      <div className="mx-auto w-full px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
        ...
        <div className="flex items-end justify-between mb-12">
          <div>
            <h2 className="text-3xl font-bold tracking-tight text-indigo-950">Explore Categories</h2>
            <p className="mt-2 text-sm text-gray-500">Hand-picked creative pathways just for you.</p>
          </div>
          <Link href="#" className="flex items-center gap-1 text-sm font-semibold text-purple-600 hover:text-purple-700 transition-colors">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
          ...
          <div className="relative overflow-hidden rounded-3xl bg-linear-to-br from-blue-100 to-indigo-100 p-8 lg:row-span-2 flex flex-col justify-between min-h-[380px] shadow-sm hover:shadow-md transition-shadow group">
            ...
            <div>
              ...
              <h3 className="mt-6 text-xl font-bold text-indigo-950">Digital Illustration</h3>
          ...
          <div className="rounded-3xl bg-purple-50 p-6 flex flex-col justify-between shadow-sm hover:shadow-md transition-shadow">
            <div>
              ...
              <h3 className="mt-4 text-lg font-bold text-indigo-950">Creative UI</h3>
          ...
          <div className="relative overflow-hidden rounded-3xl bg-purple-50/50 p-8 lg:col-span-2 flex flex-col justify-between min-h-[220px] shadow-sm hover:shadow-md transition-shadow group">
            ...
            <div className="max-w-[60%]">
              ...
              <h3 className="mt-6 text-xl font-bold text-indigo-950">Creative Writing</h3>
