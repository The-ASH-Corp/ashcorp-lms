    ...
    <section className="bg-white py-20">
      <div className="mx-auto w-full px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
        ...
        <div className="flex items-end justify-between mb-12">
          ...
          <button onClick={()=> setShowAll(!showAll)} className="flex items-center gap-1 text-sm font-semibold text-primary hover:text-purple-700 transition-colors">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:grid-cols-3">
          ...
          {displayedCategories?.map((items) => {
            return (
              <div
                key={items._id}
                className="relative overflow-hidden rounded-3xl bg-linear-to-br from-blue-100 to-indigo-100 p-8 lg:row-span-2 flex flex-col justify-between min-h-[380px] shadow-sm hover:shadow-md transition-shadow group"
              >
                {/* Top Icon */}
                <div>
