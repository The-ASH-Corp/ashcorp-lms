...
import { Sliders, Sparkles, FileText, MessageCircle } from "lucide-react";
import { IPrivacyPolicySettings } from "@/lib/redux/features/page-settings/pageSettingsApi";

interface SectionVisibilityCardProps {
  settings: IPrivacyPolicySettings;
  onChange: (updated: IPrivacyPolicySettings) => void;
}
...
export function SectionVisibilityCard({
  ...
  const sections = [
    ...
    { key: "policySections" as const, label: "Policy Sections", icon: FileText },
    { key: "supportCta" as const, label: "Support CTA", icon: MessageCircle },
  ];
