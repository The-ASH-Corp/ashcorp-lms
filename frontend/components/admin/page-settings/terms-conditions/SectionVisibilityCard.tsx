...
import { Sliders, Sparkles, FileText } from "lucide-react";
...
interface SectionVisibilityCardProps {
  settings: ITermsConditionsSettings;
  onChange: (updated: ITermsConditionsSettings) => void;
}
...
export function SectionVisibilityCard({
  ...
  const sections = [
    ...
    { key: "termsSections" as const, label: "Terms Sections", icon: FileText },
  ];
