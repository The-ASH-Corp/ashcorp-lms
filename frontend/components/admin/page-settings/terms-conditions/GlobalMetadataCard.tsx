...
import { ITermsConditionsSettings } from "@/lib/redux/features/page-settings/pageSettingsApi";

interface GlobalMetadataCardProps {
  metadata: ITermsConditionsSettings["metadata"];
  onChange: (updated: ITermsConditionsSettings["metadata"]) => void;
}
      ...
      <div className="mt-4 space-y-3.5">
        <div>
          ...
          <input
            ...
            placeholder="Terms & Conditions | Ash Academy"
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="Read the terms and conditions governing the access and use of Ash Academy LMS."
          />
        </div>
      </div>
    </section>
