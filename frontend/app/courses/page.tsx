...
//               return (
//                 course.category.toLowerCase() === catLower ||
//                 course.category === cat
//               );
//             }
//             if (typeof course.category === "object" && course.category !== null) {
//               return (
//                 (course.category as { _id?: string })._id === cat ||
//                 (course.category as { categoryName?: string }).categoryName?.toLowerCase() === catLower
//               );
//             }
//             return false;
//           });
...
//             (inst) => inst.toLowerCase() === instructorName.toLowerCase()
//           );
...
//       current.some((c) => c.toLowerCase() === value.toLowerCase())
...
//       current.some((i) => i.toLowerCase() === value.toLowerCase())
//         ? current.filter((item) => item.toLowerCase() !== value.toLowerCase())
//         : [...current, value],
//     );
//   };
