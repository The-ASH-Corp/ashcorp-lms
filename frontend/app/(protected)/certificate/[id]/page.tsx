          ...
          <div className="lg:col-span-2">
            ...
            <div className="text-center mb-8 lg:mb-12">
              ...
              <p className="text-gray-600 text-sm sm:text-base max-w-2xl mx-auto leading-relaxed">
                ...
                . This credential validates your expertise in modern engineering
                practices.
              </p>
            </div>
                ...
                <div className="bg-linear-to-br from-slate-900 via-violet-900 to-slate-900 rounded-lg p-6 sm:p-8 text-center min-h-80 sm:min-h-96 flex flex-col justify-between relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="flex justify-around text-gray-400 text-xs sm:text-sm">
                      <div>
                        <div className="mb-2 text-amber-600 font-script text-lg">
                          Ash Academy
                        </div>
              ...
              <div className="space-y-6">
                ...
                <div className="border-t border-violet-200 pt-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {[
                      ...
                      <span
                        key={skill}
                        className="text-xs bg-white text-primary px-3 py-1 rounded-full border border-violet-200 font-medium"
                      >
                        {skill}
                      </span>
                    ))}
                ...
                <div className="border-t border-violet-200 pt-6">
                  <p className="text-xs text-gray-600 italic mb-4">
                    This certificate is widely recognized by our network of 500+
                    global hiring partners.
                  </p>
                  <div className="flex gap-2">
                    <div className="w-6 h-6 bg-linear-to-br from-violet-400 to-primary rounded-full flex items-center justify-center text-white text-xs font-bold">
                      H
                    </div>
                    <div className="w-6 h-6 bg-linear-to-br from-purple-400 to-pink-600 rounded-full flex items-center justify-center text-white text-xs font-bold">
                      L
                    </div>
                  </div>
                </div>
