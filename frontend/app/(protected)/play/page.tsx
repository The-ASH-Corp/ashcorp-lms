        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="relative bg-linear-to-br from-violet-900 to-violet-950 rounded-xl overflow-hidden mb-6 aspect-video">
              ...
              <div className="absolute bottom-0 left-0 right-0 h-1 bg-violet-200">
                <div className="h-full bg-violet-600" style={{ width: '60%' }}></div>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                <div className="flex items-start gap-3 mb-3">
                  <Volume2 className="text-violet-600 mt-1" size={24} />
                  <div>
              ...
              <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                <div className="flex items-start gap-3 mb-3">
                  <BookOpen className="text-violet-600 mt-1" size={24} />
                  <div>
          ...
          <div className="lg:col-span-1">
            ...
            <div className="bg-linear-to-br from-violet-50 to-gray-50 rounded-xl p-6 border border-violet-200 mb-6 sticky top-6">
                    ...
                    {lessons.slice(2, 6).map(lesson => (
                      ...
                      >
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="text-xs text-gray-500">{lesson.duration}</p>
                          {lesson.isPlaying && <p className="text-xs text-violet-600 font-medium">Playing</p>}
                        </div>
                      </div>
                    ))}
                  </div>
              ...
              <button className="w-full mt-6 bg-violet-600 text-white font-medium py-3 rounded-lg hover:bg-violet-700 transition-colors">
                Get Certificate
              </button>
            </div>
          </div>
